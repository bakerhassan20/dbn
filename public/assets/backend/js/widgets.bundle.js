                ...
                a.addEventListener("slid.bs.carousel", function (a) {
                    1 === a.to &&
                        e(
                            ...
                            "primary",
                            [
                                18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20,
                                20, 22,
                            ]
                        );
                });
                                    ...
                                    r = new vis.DataSet([
                                        {
                                            ...
                                            color: "primary",
                                            users: [
                                                "backend/avatars/300-6.jpg",
                                                "backend/avatars/300-1.jpg",
                                            ],
                                        },
                                        {
                                            id: 2,
                                            ...
                                            progress: "84%",
                                            color: "success",
                                            users: ["backend/avatars/300-2.jpg"],
                                        },
                                        {
                                            id: 3,
                                            group: 3,
                                            ...
                                            color: "danger",
                                            users: [
                                                "backend/avatars/300-5.jpg",
                                                "backend/avatars/300-20.jpg",
                                            ],
                                        },
                                        {
                                            id: 4,
                                            ...
                                            color: "info",
                                            users: [
                                                "backend/avatars/300-23.jpg",
                                                "backend/avatars/300-12.jpg",
                                                "backend/avatars/300-9.jpg",
                                            ],
                                        },
                                    ]),
                                    i = {
                                        ...
                                        template: function (e) {
                                            ...
                                            return (
                                                a.forEach((e) => {
                                                    t += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${
                                                        l + e
                                                    }" alt="" /></div>`;
                                                }),
                    ...
                    r = new vis.DataSet([
                        {
                            ...
                            progress: "60%",
                            color: "primary",
                            users: ["backend/avatars/300-6.jpg", "backend/avatars/300-1.jpg"],
                        },
                        {
                            id: 2,
                            group: "qa",
                        ...
                        },
                        {
                            ...
                            progress: "55%",
                            color: "danger",
                            users: ["backend/avatars/300-5.jpg", "backend/avatars/300-20.jpg"],
                        },
                        {
                            id: 4,
                            group: "dev",
        ...
        (e = document.querySelector("#kt_timeline_widget_2_card")) &&
            KTUtil.on(
                ...
                function (e) {
                    ...
                    !0 === this.checked
                        ? (a.classList.add("form-check-success"),
                          l.classList.remove("bg-primary"),
                          l.classList.add("bg-success"),
                          (o.innerText = "Done"),
                          o.classList.remove("badge-light-primary"),
                          o.classList.add("badge-light-success"))
                                        ...
                                        r = new vis.DataSet([
                                            {
                                                ...
                                                color: "primary",
                                                users: [
                                                    "backend/avatars/300-7.jpg",
                                                    "backend/avatars/300-2.jpg",
                                                ],
                                            },
                                            {
                                                id: 2,
                                            ...
                                            },
                                            {
                                                ...
                                                color: "info",
                                                users: [
                                                    "backend/avatars/300-3.jpg",
                                                    "backend/avatars/300-11.jpg",
                                                    "backend/avatars/300-13.jpg",
                                                ],
                                            },
                                        ]),
                                        i = {
...
var KTChartsWidget1 = {
    init: function () {
        !(function () {
            ...
            if (e) {
                var a = e.hasAttribute("data-kt-negative-color")
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        t.set(
                            "cursor",
                            am5xy.XYCursor.new(a, { behavior: "none" })
                        ).lineY.set("visible", !1);
                        var l = [
                                {
                                    year: "2003",
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        function l(e) {
                            for (var a = 0, t = 0, l = 0; l < e.length; l++)
                                (a += (o = e[l]).male), (t += o.female);
                            for (l = 0; l < e.length; l++) {
                                var o;
                                ((o = e[l]).malePercent =
                                    (-1 * Math.round((o.male / a) * 1e4)) /
                                    100),
                                    (o.femalePercent =
                                        Math.round((o.female / t) * 1e4) / 100);
                            }
                            return e;
                        }
                        a = l(a);
                        ...
                        var r = o.container.children.push(
                            am5.Container.new(o, {
                        ...
                        var c = r.children.push(
                            am5map.MapChart.new(o, {
                                panX: "none",
                                panY: "none",
                                wheelY: "none",
                        ...
                        p.mapPolygons.template.setAll({
                            ...
                            p.mapPolygons.template.events.on(
                                ...
                                function (e) {
                                    ...
                                    for (
                                        var a = e.target.dataItem.dataContext.id
                                                .split("-")
                                                .pop(),
                                            o = l(t[a]),
                                            r = 0;
                                        ...
                                        d.data.setIndex(r, o[r]),
                                            g.data.setIndex(r, o[r]);
                                    u.set(
                                        "text",
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var o = t.xAxes.push(
                            ...
                            i = t.yAxes.push(
                                am5xy.ValueAxis.new(a, { renderer: r })
                            );
        ...
        init: function () {
            e(
                ...
                e(
                    ...
                    [
                        2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3200,
                        3200, 2600, 3100, 2800, 2400, 2400,
                    ],
                    [
                        "Apr 02",
                        "Apr 03",
                ...
                e(
                    ...
                    [
                        1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200,
                        3300, 2400, 2400, 3e3, 3200, 3100,
                    ],
                    [
                        "Jun 2021",
                        "Jul 2021",
                ...
                e(
                    ...
                    [
                        3e3, 2100, 3300, 3100, 1800, 1800, 2400, 2400, 3100,
                        3100, 2400, 2400, 3e3, 2400, 2800,
                    ],
                    [
                        "Sep 2021",
                        "Oct 2021",
        ...
        init: function () {
            e(
                ...
                e(
                    ...
                    [
                        2300, 2300, 2e3, 3100, 3100, 2800, 2400, 2400, 3100,
                        2900, 3200, 3200, 2600, 2600, 3200,
                    ],
                    [
                        "Apr 01",
                        "Apr 02",
                ...
                e(
                    ...
                    [
                        2600, 3400, 2300, 2300, 2e3, 3100, 3100, 2900, 3200,
                        3200, 2600, 3100, 2800, 2400, 2400,
                    ],
                    [
                        "Apr 02",
                ...
                e(
                    ...
                    [
                        1800, 1800, 2400, 2400, 3100, 3100, 3e3, 2100, 3200,
                        3200, 2400, 2400, 3e3, 3200, 3100,
                    ],
                    [
                        "Jun 2021",
                        "Jul 2021",
                ...
                e(
                    ...
                    [
                        3e3, 2100, 3200, 3200, 1800, 1800, 2400, 2400, 3100,
                        3100, 2400, 2400, 3e3, 2400, 2800,
                    ],
                    [
                        "Sep 2021",
        ...
        init: function () {
            e(
                ...
                e(
                    ...
                    [
                        2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3400,
                        3400, 2600, 3200, 2800, 2400, 2400,
                    ],
                    [
                        "Apr 02",
                        "Apr 03",
                ...
                e(
                    ...
                    [
                        3200, 2100, 3200, 3200, 3200, 3500, 3e3, 2400, 3250,
                        2400, 2400, 3250, 3e3, 2400, 2800,
                    ],
                    [
                        "Sep 2021",
                        "Oct 2021",
                ...
                var r = (a.size - a.lineWidth) / 2,
                    i = function (e, a, t) {
                        (t = Math.min(Math.max(0, t || 1), 1)),
                            o.beginPath(),
                            o.arc(0, 0, r, 0, 2 * Math.PI * t, !1),
                            (o.strokeStyle = e),
                            (o.lineCap = "round"),
                            (o.lineWidth = a),
                            o.stroke();
                    };
                i("#E4E6EF", a.lineWidth, 1),
                    i(
                        KTUtil.getCssVariableValue("--bs-primary"),
                        a.lineWidth,
                        100 / 150
        ...
        if (e) {
            var a = e.querySelector('[data-kt-element="audio-track-1"]'),
                ...
                c = function (e) {
                    var a = parseInt(e % 60);
                    return (
                        parseInt((e / 60) % 60) + ":" + (a < 10 ? "0" : "") + a
                    );
                };
            o.innerHTML = c(a.duration);
            a.addEventListener("timeupdate", function () {
                (l.innerHTML = c(a.currentTime)),
                    (t.value = (a.currentTime / a.duration) * 100),
                    this.ended &&
                        (i.classList.remove("d-none"),
                        s.classList.add("d-none"));
            }),
                r.addEventListener("click", function () {
                    a.duration > 0 && !a.paused
                        ? (a.pause(),
                          i.classList.remove("d-none"),
                          s.classList.add("d-none"))
                        : a.readyState >= 2 &&
