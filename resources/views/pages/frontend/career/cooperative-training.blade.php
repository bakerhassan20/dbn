				...
				<div class="container flex-container padding-top-60 padding-bottom-120">
							...
							<div class="margin-top-30 anim-fade tr-delay-02">
								...
								<a class="skew-btn js-pointer-large"
									...
									<span class="skew-btn__box">
										<span class="skew-btn__content text-color-white">Cooperative Training</span>
					...
					<div class="seven-columns column-100-100 padding-top-60">
						...
						<div id="training">
							...
							<form action="{{ route('cooperative.save') }}" method="post" name="formobrsv" id="joinus_form" enctype="multipart/form-data"
								...
								<div class="twelve-columns">
									<div class="column-r-margin-10">
										<input type="number" name="phone" placeholder="Enter your phone number"
											id="phone" required="" class="form-input js-pointer-small">
									</div>
								...
								<div class="twelve-columns">
									<div class="column-r-margin-10">
										<input type="text" name="university" placeholder="Enter your University Name"
											id="university" required="" class="form-input js-pointer-small">
									</div>
								...
								<div class="twelve-columns">
									<div class="column-r-margin-10">
										<select id="Graduate" name="Graduate" required=""
											...
											<option value="">Graduate IN</option>
											<option value="3 Months">3 Months</option>
											<option value="6 Months">6 Months</option>
											<option value="Less than 1 year">Less than 1 year</option>
										</select>
									</div>
                                    <div class="text-danger">{{$errors->first('Graduate')}}</div>
								</div><!-- column end -->
								...
								<div class="twelve-columns">
									<div class="column-r-margin-10">
										<input type="file" name="file" placeholder="" id="file" required="" accept=".pdf,.doc,.docx"
											class="form-input js-pointer-small">
									</div>
