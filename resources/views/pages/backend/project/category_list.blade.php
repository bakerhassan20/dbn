                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_export_users_form"
                                            action="{{ route('project.categories.add') }}" class="form" method="post">
                                            @csrf
                                            <!--begin::Input group-->
                                    ...
                                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                        ...
                                        <form id="kt_modal_add_category_form" class="form" action="#">
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fw-bold fs-6 mb-2">Slug (English)</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fw-bold fs-6 mb-2">Slug (العربية)</label>
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                ...
                                                <div class="mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fw-bold fs-6 mb-5">description (English)</label>
                                                    <!--end::Label-->
                                                    <!--begin::Roles-->

                                                    <textarea id="editor-en" rows="4" name="description_en" class="tox-target">
                                                ...
                                                <div class="mb-7">
                                                    <!--begin::Label-->
                                                    <label class="required fw-bold fs-6 mb-5">description (العربية)</label>
                                                    <!--end::Label-->
                                                    <!--begin::Roles-->

                                                    <textarea id="editor-ar" rows="4" name="description_ar" class="tox-target">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            @forelse ($categories as $category)
                                ...
                                <tr>
                                    ...
                                    <!--begin::Projects=-->
                                    <td>
                                        <div class="badge badge-light fw-bolder">{{ $category['projects'] }}</div>
                                    </td>
                                    <!--end::Projects=-->
                                    <!--begin::Status=-->
